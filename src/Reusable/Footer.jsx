  ...
  return (
    <footer className="pt-[6rem] px-[1rem] md:px-[4rem] 2xl:px-[6rem] grid">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 2xl:grid-cols-3 lg:grid-cols-3 items-center order-2 2xl:order-1 lg:order-1 md:order-2 mt-4 2xl:mt-[0rem] lg:mt-[0rem] md:mt-[4rem]">
        ...
        <div className="mt-4 order-1 2xl:order-2 lg:order-2 md:order-1">
        ...
        <div
          className="border-t-2 w-full mt-[4rem] py-[2rem] flex justify-between order-3 2xl:order-3 lg:order-3 md:order-3"
